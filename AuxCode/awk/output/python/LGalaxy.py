...
('t_des',numpy.float32,RNUM),
('t_sput_HotGas',numpy.float32,1),
('t_sput_EjectedMass',numpy.float32,1),
('DustColdGasRates',numpy.float32,NUM_COLDGAS_DUST_RATES),
('DustHotGasRates',numpy.float32,NUM_HOTGAS_DUST_RATES),
('DustEjectedMassRates',numpy.float32,1),
('t_acc',numpy.float32,RNUM),
('f_cmax',numpy.float32,RNUM),
('ColdGasDiff_elements',numpy.float32,NUM_ELEMENTS),
('ColdGasClouds_elements',numpy.float32,NUM_ELEMENTS),
('DustColdGasDiff_elements',numpy.float32,NUM_ELEMENTS),
('DustColdGasClouds_elements',numpy.float32,NUM_ELEMENTS),
('DustHotGas_elements',numpy.float32,NUM_ELEMENTS),
('DustEjectedMass_elements',numpy.float32,NUM_ELEMENTS),
('ColdGasDiffRings_elements',numpy.float32,RNUM),
('ColdGasCloudsRings_elements',numpy.float32,RNUM),
('DustColdGasDiffRings_elements',numpy.float32,RNUM),
('DustColdGasCloudsRings_elements',numpy.float32,RNUM),
('ending','i4',0)
])
properties_used = {}
