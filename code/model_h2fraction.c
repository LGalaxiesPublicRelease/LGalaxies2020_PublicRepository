...
#ifdef DETAILED_DUST
  //ROB: I have put this function directly after the H2 fraction is updated here, so that the cloud and diffuse gas arrays are always in sync with the current timestep's H2 fraction. (09-03-22)
