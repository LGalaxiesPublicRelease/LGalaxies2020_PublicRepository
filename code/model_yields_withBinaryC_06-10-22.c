...
#endif  
	//printf("\nmodel_yields.c\nGal[p].DustColdGasCloudsRings_elements[0][O_NUM] = %e | Gal[p].ColdGasCloudsRings_elements[0][O_NUM] = %e\n",
	//						Gal[p].DustColdGasCloudsRings_elements[0][O_NUM], Gal[p].ColdGasCloudsRings_elements[0][O_NUM]);
    //**********
...
*/
    ...
    //printf("Gal[p].DustColdGasCloudsRings_elements[0][O_NUM] = %e | Gal[p].ColdGasCloudsRings_elements[0][O_NUM] = %e\n",
    //    		Gal[p].DustColdGasCloudsRings_elements[0][O_NUM], Gal[p].ColdGasCloudsRings_elements[0][O_NUM]);
