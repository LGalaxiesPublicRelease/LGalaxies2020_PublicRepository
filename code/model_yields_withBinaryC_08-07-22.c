...
//Third, redistribute unprocessed masses from AGB and SNe-Ia to SNe-II, if necessary
    	...
    	double TotMassEjected, TotElementsEjected = 0.0, TotUnProcessedElements = 0.0, TotElements = 0.0;
...
#ifdef H2_AND_RINGS
			TotElements += Gal[p].DiskMassRings_elements[jj][ee];
#else //H2_AND_RINGS
			TotElements += Gal[p].DiskMass_elements[ee];
#endif //H2_AND_RINGS
		}
		/*printf("\nBEFORE ELEMENT CORR:\n");
		printf("TotMassEjected = %e | TotElementsEjected = %e | Diff = %e (%f) | TotUnprocessedElements = %e | TotElements = %e [Msun]\n", TotMassEjected, TotElementsEjected, TotMassEjected-TotElementsEjected, TotMassEjected/TotElementsEjected, TotUnProcessedElements, TotElements);
...
*/
		...
		printf("TotMassEjected = %e | TotElementsEjected = %e | Diff = %e | TotUnprocessedElements = %e | TotElements = %e [Msun]\n", TotMassEjected, TotElementsEjected, TotMassEjected-TotElementsEjected, TotUnProcessedElements, TotElements);
		printf("TotSNIIMassEjected = %e | TotSNIIElementsEjected = %e | Diff = %e (%e) | TotSNIIUnprocessedElements = %e [Msun]\n", SNIIEjectaMass*1.e10/Hubble_h, TotSNIIElementsEjected, (SNIIEjectaMass*1.e10/Hubble_h)-TotSNIIElementsEjected, (SNIIEjectaMass*1.e10/Hubble_h)/TotSNIIElementsEjected, TotSNIIUnProcessedElements);
		printf("TotSNIaMassEjected = %e | TotSNIaElementsEjected = %e | Diff = %e (%e) | TotSNIaUnprocessedElements = %e [Msun]\n", SNIaEjectaMass*1.e10/Hubble_h, TotSNIaElementsEjected, (SNIaEjectaMass*1.e10/Hubble_h)-TotSNIaElementsEjected, (SNIaEjectaMass*1.e10/Hubble_h)/TotSNIaElementsEjected, TotSNIaUnProcessedElements);
		printf("TotAGBMassEjected = %e  | TotAGBElementsEjected = %e  | Diff = %e (%e) | TotAGBUnprocessedElements = %e [Msun]\n", AGBEjectaMass*1.e10/Hubble_h, TotAGBElementsEjected, (AGBEjectaMass*1.e10/Hubble_h)-TotAGBElementsEjected, (AGBEjectaMass*1.e10/Hubble_h)/TotAGBElementsEjected, TotAGBUnProcessedElements);
*/
		...
		printf("TotMetalEjected = %e | TotMetalElementsEjected = %e | Diff = %e (%f) | TotUnProcessedMetals = %e | TotMetalUnProcessedElements = %e [Msun]\n", TotMetalEjected, TotMetalElementsEjected, TotMetalEjected-TotMetalElementsEjected, TotMetalEjected/TotMetalElementsEjected, TotUnProcessedMetals, TotMetalUnProcessedElements);
...
*/
		...
		/*if (isnan(Gal[p].MetalsDiskMassRings[jj][2])) {
			printf("AGBs:\n");
			printf("Gal[%i].MetalsDiskMassRings[jj][0] = %e | SNIIUnProcessedMetals = %e | TotMetalSNIIUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][0]*1.e10/Hubble_h, SNIIUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIIUnProcessedElements);
			printf("Gal[%i].MetalsDiskMassRings[jj][1] = %e | SNIaUnProcessedMetals = %e | TotMetalSNIaUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][1]*1.e10/Hubble_h, SNIaUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIaUnProcessedElements);
			printf("Gal[%i].MetalsDiskMassRings[jj][2] = %e | AGBUnProcessedMetals = %e | TotMetalAGBUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][2]*1.e10/Hubble_h, AGBUnProcessedMetals*1.e10/Hubble_h, TotMetalAGBUnProcessedElements);
			for(ee=0;ee<NUM_ELEMENTS;ee++) {
				printf("Gal[%i].DiskMassRings_elements[jj][%i] = %e | SNIIUnProcessedElements[%i] = %e | SNIaUnProcessedElements[%i] = %e | AGBUnProcessedElements[%i] = %e | TotUnProcessedElements[%i] = %e [Msun]\n",
						p , ee, Gal[p].DiskMassRings_elements[jj][ee], ee, SNIIUnProcessedElements[ee], ee, SNIaUnProcessedElements[ee], ee, AGBUnProcessedElements[ee], ee, SNIIUnProcessedElements[ee]+SNIaUnProcessedElements[ee]+AGBUnProcessedElements[ee]);
			}
			exit(1);
		}*/
		//printf("\nBEFORE EXCESS CORR:\n");
		if (Gal[p].MetalsDiskMassRings[jj][2] < AGBUnProcessedMetals && AGBUnProcessedMetals > 0.0) {
			/*printf("AGBs:\n");
			printf("Gal[%i].MetalsDiskMassRings[jj][0] = %e | SNIIUnProcessedMetals = %e | TotMetalSNIIUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][0]*1.e10/Hubble_h, SNIIUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIIUnProcessedElements);
			printf("Gal[%i].MetalsDiskMassRings[jj][1] = %e | SNIaUnProcessedMetals = %e | TotMetalSNIaUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][1]*1.e10/Hubble_h, SNIaUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIaUnProcessedElements);
			printf("Gal[%i].MetalsDiskMassRings[jj][2] = %e | AGBUnProcessedMetals = %e | TotMetalAGBUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][2]*1.e10/Hubble_h, AGBUnProcessedMetals*1.e10/Hubble_h, TotMetalAGBUnProcessedElements);
			for(ee=0;ee<NUM_ELEMENTS;ee++) {
				printf("Gal[%i].DiskMassRings_elements[jj][%i] = %e | SNIIUnProcessedElements[%i] = %e | AGBUnProcessedElements[%i] = %e | TotUnProcessedElements[%i] = %e [Msun]\n",
						p , ee, Gal[p].DiskMassRings_elements[jj][ee], ee, SNIIUnProcessedElements[ee], ee, AGBUnProcessedElements[ee], ee, SNIIUnProcessedElements[ee]+SNIaUnProcessedElements[ee]+AGBUnProcessedElements[ee]);
			}
*/
			AGBMetalExcessFactor1 = Gal[p].MetalsDiskMassRings[jj][2]/AGBUnProcessedMetals;
			AGBMetalExcessFactor2 = AGBUnProcessedMetals - Gal[p].MetalsDiskMassRings[jj][2]; //in code units
			//if (AGBMetalExcessFactor1 != AGBMetalExcessFactor1) printf("Here: AGBMetalExcessFactor1 = %e\n", AGBMetalExcessFactor1);
			//if (AGBMetalExcessFactor2 != AGBMetalExcessFactor2) printf("Here: AGBMetalExcessFactor2 = %e\n", AGBMetalExcessFactor2);
			...
			TotMetalSNIIUnProcessedElements = 0.0, TotMetalSNIaUnProcessedElements = 0.0, TotMetalAGBUnProcessedElements = 0.0;
			for(ee=2;ee<NUM_ELEMENTS;ee++) {
...
*/
		...
		if (Gal[p].MetalsDiskMassRings[jj][1] < SNIaUnProcessedMetals && SNIaUnProcessedMetals > 0.0) {
			/*printf("SNe-Ia:\n");
			printf("Gal[%i].MetalsDiskMassRings[jj][0] = %e | SNIIUnProcessedMetals = %e | TotMetalSNIIUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][0]*1.e10/Hubble_h, SNIIUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIIUnProcessedElements);
			printf("Gal[%i].MetalsDiskMassRings[jj][1] = %e | SNIaUnProcessedMetals = %e | TotMetalSNIaUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][1]*1.e10/Hubble_h, SNIaUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIaUnProcessedElements);
			printf("Gal[%i].MetalsDiskMassRings[jj][2] = %e | AGBUnProcessedMetals = %e | TotMetalAGBUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][2]*1.e10/Hubble_h, AGBUnProcessedMetals*1.e10/Hubble_h, TotMetalAGBUnProcessedElements);
			for(ee=0;ee<NUM_ELEMENTS;ee++) {
				printf("Gal[%i].DiskMassRings_elements[jj][%i] = %e | SNIIUnProcessedElements[%i] = %e | SNIaUnProcessedElements[%i] = %e | TotUnProcessedElements[%i] = %e [Msun]\n",
						p , ee, Gal[p].DiskMassRings_elements[jj][ee], ee, SNIIUnProcessedElements[ee], ee, SNIaUnProcessedElements[ee], ee, SNIIUnProcessedElements[ee]+SNIaUnProcessedElements[ee]+AGBUnProcessedElements[ee]);
			}
*/
			SNIaMetalExcessFactor1 = Gal[p].MetalsDiskMassRings[jj][1]/SNIaUnProcessedMetals;
			SNIaMetalExcessFactor2 = SNIaUnProcessedMetals - Gal[p].MetalsDiskMassRings[jj][1]; //in code units
...
*/
		...
		if (Gal[p].MetalsDiskMassRings[jj][0] < SNIIUnProcessedMetals && SNIIUnProcessedMetals > 0.0) {
			if (SNIIUnProcessedMetals - Gal[p].MetalsDiskMassRings[jj][0] > TINY_MASS) //N.B. TINY_MASS should equal 1.e-08
				printf("WARNING: SNIIUnProcessedMetals = %e exceeded Gal[p].MetalsDiskMassRings[%i][0] = %e [code units] \nNow fixed to: SNIIUnProcessedMetals = Gal[p].MetalsDiskMassRings[%i][0]\n",
						SNIIUnProcessedMetals, jj, Gal[p].MetalsDiskMassRings[jj][0], jj);
			SNIIMetalExcessFactor = Gal[p].MetalsDiskMassRings[jj][0]/SNIIUnProcessedMetals;
			...
			/*if (SNIIUnProcessedMetals - Gal[p].MetalsDiskMassRings[jj][0] < TINY_MASS) { //N.B. TINY_MASS should equal 1.e-08
				...
				printf("Gal[%i].MetalsDiskMassRings[jj][1] = %e | SNIaUnProcessedMetals = %e | TotMetalSNIaUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][1]*1.e10/Hubble_h, SNIaUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIaUnProcessedElements);
				printf("Gal[%i].MetalsDiskMassRings[jj][2] = %e | AGBUnProcessedMetals = %e | TotMetalAGBUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][2]*1.e10/Hubble_h, AGBUnProcessedMetals*1.e10/Hubble_h, TotMetalAGBUnProcessedElements);
				if (isnan(Gal[p].MetalsDiskMassRings[jj][2])) printf("TEST\n");
				for(ee=0;ee<NUM_ELEMENTS;ee++) {
					printf("Gal[%i].DiskMassRings_elements[jj][%i] = %e | SNIIUnProcessedElements[%i] = %e | SNIaUnProcessedElements[%i] = %e | AGBUnProcessedElements[%i] = %e | TotUnProcessedElements[%i] = %e [Msun]\n",
											p , ee, Gal[p].DiskMassRings_elements[jj][ee], ee, SNIIUnProcessedElements[ee], ee, SNIaUnProcessedElements[ee], ee, AGBUnProcessedElements[ee], ee, SNIIUnProcessedElements[ee]+SNIaUnProcessedElements[ee]+AGBUnProcessedElements[ee]);
				}
				printf("WARNING: SNIIUnProcessedMetals = %e exceeds Gal[p].MetalsDiskMassRings[%i][0] = %e [code units]", SNIIUnProcessedMetals, jj, Gal[p].MetalsDiskMassRings[jj][0]);
				//exit(1);
			}*/
		}
#else
...
//Third, redistribute unprocessed masses from AGB and SNe-Ia to SNe-II, if necessary
		...
		for(ee=0;ee<NUM_ELEMENTS;ee++) {
			...
			TotAGBUnProcessedElements += AGBUnProcessedElements[ee];
#ifdef H2_AND_RINGS
			TotElements += Gal[p].BulgeMassRings_elements[jj][ee];
#else //H2_AND_RINGS
			TotElements += Gal[p].BulgeMass_elements[ee];
#endif //H2_AND_RINGS
		}
		/*printf("\nBEFORE ELEMENT CORR:\n");
		printf("TotMassEjected = %e | TotElementsEjected = %e | Diff = %e (%f) | TotUnprocessedElements = %e | TotElements = %e [Msun]\n", TotMassEjected, TotElementsEjected, TotMassEjected-TotElementsEjected, TotMassEjected/TotElementsEjected, TotUnProcessedElements, TotElements);
...
*/
		...
		if (Gal[p].MetalsBulgeMassRings[jj][2] < AGBUnProcessedMetals && AGBUnProcessedMetals > 0.0) {
			AGBMetalExcessFactor1 = Gal[p].MetalsBulgeMassRings[jj][2]/AGBUnProcessedMetals;
			AGBMetalExcessFactor2 = AGBUnProcessedMetals - Gal[p].MetalsBulgeMassRings[jj][2]; //in code units
			AGBUnProcessedMetals *= AGBMetalExcessFactor1;
			for(ee=2;ee<NUM_ELEMENTS;ee++) {
				AGBElementExcessFactor[ee] = AGBUnProcessedElements[ee] - (AGBUnProcessedElements[ee]*AGBMetalExcessFactor1);
				AGBUnProcessedElements[ee] *= AGBMetalExcessFactor1;
		...
		if (Gal[p].MetalsBulgeMassRings[jj][1] < SNIaUnProcessedMetals && SNIaUnProcessedMetals > 0.0) {
			SNIaMetalExcessFactor1 = Gal[p].MetalsBulgeMassRings[jj][1]/SNIaUnProcessedMetals;
			SNIaMetalExcessFactor2 = SNIaUnProcessedMetals - Gal[p].MetalsBulgeMassRings[jj][1]; //in code units
			SNIaUnProcessedMetals *= SNIaMetalExcessFactor1;
			for(ee=2;ee<NUM_ELEMENTS;ee++) {
				SNIaElementExcessFactor[ee] = SNIaUnProcessedElements[ee] - (SNIaUnProcessedElements[ee]*SNIaMetalExcessFactor1);
				SNIaUnProcessedElements[ee] *= SNIaMetalExcessFactor1;
		...
		if (Gal[p].MetalsBulgeMassRings[jj][0] < SNIIUnProcessedMetals && SNIIUnProcessedMetals > 0.0) {
			if (SNIIUnProcessedMetals - Gal[p].MetalsBulgeMassRings[jj][0] > TINY_MASS) //N.B. TINY_MASS should equal 1.e-08
				printf("WARNING: SNIIUnProcessedMetals = %e exceeded Gal[p].MetalsBulgeMassRings[%i][0] = %e [code units] \nNow fixed to: SNIIUnProcessedMetals = Gal[p].MetalsBulgeMassRings[%i][0]\n",
						SNIIUnProcessedMetals, jj, Gal[p].MetalsBulgeMassRings[jj][0], jj);
			SNIIMetalExcessFactor = Gal[p].MetalsBulgeMassRings[jj][0]/SNIIUnProcessedMetals;
			SNIIUnProcessedMetals *= SNIIMetalExcessFactor;
			for(ee=2;ee<NUM_ELEMENTS;ee++) {
				SNIIUnProcessedElements[ee] *= SNIIMetalExcessFactor;
			}
...
//Third, redistribute unprocessed masses from AGB and SNe-Ia to SNe-II, if necessary
		...
		for(ee=0;ee<NUM_ELEMENTS;ee++) {
			...
			TotSNIaUnProcessedElements += SNIaUnProcessedElements[ee];
			TotAGBUnProcessedElements += AGBUnProcessedElements[ee];
			TotElements += Gal[p].ICM_elements[ee];
		}
		/*printf("\nBEFORE ELEMENT CORR:\n");
		printf("TotMassEjected = %e | TotElementsEjected = %e | Diff = %e (%f) | TotUnprocessedElements = %e | TotElements = %e [Msun]\n", TotMassEjected, TotElementsEjected, TotMassEjected-TotElementsEjected, TotMassEjected/TotElementsEjected, TotUnProcessedElements, TotElements);
		printf("TotSNIIMassEjected = %e | TotSNIIElementsEjected = %e | Diff = %e (%f) | TotSNIIUnprocessedElements = %e [Msun]\n", SNIIEjectaMass*1.e10/Hubble_h, TotSNIIElementsEjected, (SNIIEjectaMass*1.e10/Hubble_h)-TotSNIIElementsEjected, (SNIIEjectaMass*1.e10/Hubble_h)/TotSNIIElementsEjected, TotSNIIUnProcessedElements);
...
*/
		...
		if (Gal[p].MetalsICM[2] < AGBUnProcessedMetals && AGBUnProcessedMetals > 0.0) {
			AGBMetalExcessFactor1 = Gal[p].MetalsICM[2]/AGBUnProcessedMetals;
			AGBMetalExcessFactor2 = AGBUnProcessedMetals - Gal[p].MetalsICM[2]; //in code units
			AGBUnProcessedMetals *= AGBMetalExcessFactor1;
			for(ee=2;ee<NUM_ELEMENTS;ee++) {
				AGBElementExcessFactor[ee] = AGBUnProcessedElements[ee] - (AGBUnProcessedElements[ee]*AGBMetalExcessFactor1);
				AGBUnProcessedElements[ee] *= AGBMetalExcessFactor1;
		...
		if (Gal[p].MetalsICM[1] < SNIaUnProcessedMetals && SNIaUnProcessedMetals > 0.0) {
			SNIaMetalExcessFactor1 = Gal[p].MetalsICM[1]/SNIaUnProcessedMetals;
			SNIaMetalExcessFactor2 = SNIaUnProcessedMetals - Gal[p].MetalsICM[1]; //in code units
			SNIaUnProcessedMetals *= SNIaMetalExcessFactor1;
			for(ee=2;ee<NUM_ELEMENTS;ee++) {
				SNIaElementExcessFactor[ee] = SNIaUnProcessedElements[ee] - (SNIaUnProcessedElements[ee]*SNIaMetalExcessFactor1);
				SNIaUnProcessedElements[ee] *= SNIaMetalExcessFactor1;
		...
		if (Gal[p].MetalsICM[0] < SNIIUnProcessedMetals && SNIIUnProcessedMetals > 0.0) {
			if (SNIIUnProcessedMetals - Gal[p].MetalsICM[0] > TINY_MASS) //N.B. TINY_MASS should equal 1.e-08
				printf("\nWARNING: SNIIUnProcessedMetals = %e exceeded Gal[p].MetalsICM[0] = %e [code units] \nNow fixed to: SNIIUnProcessedMetals = Gal[p].MetalsICM[0]\n",
						SNIIUnProcessedMetals, Gal[p].MetalsICM[0]);
			SNIIMetalExcessFactor = Gal[p].MetalsICM[0]/SNIIUnProcessedMetals;
			SNIIUnProcessedMetals *= SNIIMetalExcessFactor;
			for(ee=2;ee<NUM_ELEMENTS;ee++) {
				SNIIUnProcessedElements[ee] *= SNIIMetalExcessFactor;
			}
...
/*void rescale_ejected_material() {
//ROB: (06-07-22): New way to synchronise ejected total masses, metals, and elements :
//First, correct element unprocessed masses so that total elements ejected matches total mass ejected
//Second, correct metal unprocessed masses so that total metals ejected matches total metal elements ejected
#ifdef INDIVIDUAL_ELEMENTS
		//##########
		//1) Correct element unprocessed masses so that total elements ejected matches total mass ejected:
		double TotMassEjected, TotElementsEjected = 0.0, TotUnProcessedElements = 0.0, TotElements = 0.0;
