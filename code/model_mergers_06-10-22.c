...
#ifdef DETAILED_DUST
  transfer_material(t,"HotGas",p,"HotGas",1.,0.,1.,"model_mergers.c", __LINE__); //Diff_fraction is set to 1.0 so that dust in the HotGas of p is 100% transferred to t, when DUST_HOTGAS is on.
