...
//ROB: (04-07-22): New way to scale unprocessed components:
...
//Second, correct metal unprocessed masses so that total metals ejected matches total metal elements ejected
    	...
    	for(ee=0;ee<NUM_ELEMENTS;ee++) {
			...
			/*if (Gal[p].DiskMassRings_elements[jj][ee] < 0.0) {
				printf("****SNIIAllElements_old[%i] = %e | SNIIAllElements_new[%i] = %e \nGal[p].DiskMassRings_elements[%i][%i] = %e | TotUnProcessedElements[%i] = %e | Gal[p].ColdGasRings_elements[%i][%i] = %e \n",
						ee, SNIIAllElements[ee]/SNIIElementCorrectionFactor, ee, SNIIAllElements[ee], jj, ee, Gal[p].DiskMassRings_elements[jj][ee],
						ee, SNIIUnProcessedElements[ee]+SNIaUnProcessedElements[ee]+AGBUnProcessedElements[ee], jj, ee, Gal[p].ColdGasRings_elements[jj][ee]);
				stopper = 1;
			}*/
    	}
		...
		double SNIaMetalExcessFactor1, SNIaMetalExcessFactor2, AGBMetalExcessFactor1, AGBMetalExcessFactor2;
		double SNIaElementExcessFactor[NUM_ELEMENTS], AGBElementExcessFactor[NUM_ELEMENTS];
		for(ee=0;ee<NUM_ELEMENTS;ee++)
			AGBElementExcessFactor[ee] = 0.0;
		printf("BEFORE EXCESS CORR:\n");
		if (Gal[p].MetalsDiskMassRings[jj][2] < AGBUnProcessedMetals) {
			printf("AGBs:\n");
			...
			//AGBMetalExcessFactor = AGBUnProcessedMetals - Gal[p].MetalsDiskMassRings[jj][2]; //in code units
			//AGBUnProcessedMetals -= AGBMetalExcessFactor;
			...
			for(ee=2;ee<NUM_ELEMENTS;ee++) {
				//AGBUnProcessedElements[ee] -= (AGBMetalExcessFactor/(NUM_ELEMENTS-2))*1.e10/Hubble_h;
				//SNIIUnProcessedElements[ee] += (AGBMetalExcessFactor/(NUM_ELEMENTS-2))*1.e10/Hubble_h;
		...
		if (Gal[p].MetalsDiskMassRings[jj][1] < SNIaUnProcessedMetals) {
			printf("SNe-Ia:\n");
			printf("Gal[%i].MetalsDiskMassRings[jj][0] = %e | SNIIUnProcessedMetals = %e | TotMetalSNIIUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][0]*1.e10/Hubble_h, SNIIUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIIUnProcessedElements);
			printf("Gal[%i].MetalsDiskMassRings[jj][1] = %e | SNIaUnProcessedMetals = %e | TotMetalSNIaUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][1]*1.e10/Hubble_h, SNIaUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIaUnProcessedElements);
			printf("Gal[%i].MetalsDiskMassRings[jj][2] = %e | AGBUnProcessedMetals = %e | TotMetalAGBUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][2]*1.e10/Hubble_h, AGBUnProcessedMetals*1.e10/Hubble_h, TotMetalAGBUnProcessedElements);
		...
		if (Gal[p].MetalsDiskMassRings[jj][0] < SNIIUnProcessedMetals) {
			printf("SNe-II:\n");
			printf("Gal[%i].MetalsDiskMassRings[jj][0] = %e | SNIIUnProcessedMetals = %e | TotMetalSNIIUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][0]*1.e10/Hubble_h, SNIIUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIIUnProcessedElements);
			printf("Gal[%i].MetalsDiskMassRings[jj][1] = %e | SNIaUnProcessedMetals = %e | TotMetalSNIaUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][1]*1.e10/Hubble_h, SNIaUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIaUnProcessedElements);
			printf("Gal[%i].MetalsDiskMassRings[jj][2] = %e | AGBUnProcessedMetals = %e | TotMetalAGBUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][2]*1.e10/Hubble_h, AGBUnProcessedMetals*1.e10/Hubble_h, TotMetalAGBUnProcessedElements);
			for(ee=0;ee<NUM_ELEMENTS;ee++) {
				printf("Gal[%i].DiskMassRings_elements[jj][%i] = %e | TotUnProcessedElements[%i] = %e [Msun]\n", p , ee, Gal[p].DiskMassRings_elements[jj][ee], ee, SNIIUnProcessedElements[ee]+SNIaUnProcessedElements[ee]+AGBUnProcessedElements[ee]);
			}
			printf("AFTER EXCESS CORR:\n");
			printf("Gal[%i].MetalsDiskMassRings[jj][0] = %e | SNIIUnProcessedMetals = %e | TotMetalSNIIUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][0]*1.e10/Hubble_h, SNIIUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIIUnProcessedElements);
			printf("Gal[%i].MetalsDiskMassRings[jj][1] = %e | SNIaUnProcessedMetals = %e | TotMetalSNIaUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMassRings[jj][1]*1.e10/Hubble_h, SNIaUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIaUnProcessedElements);
		...
		/*if (Gal[p].MetalsDiskMass[0] < SNIIUnProcessedMetals) {
			printf("SNe-II:\n");
			printf("Gal[%i].MetalsDiskMass[0] = %e | SNIIUnProcessedMetals = %e | TotMetalSNIIUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMass[0]*1.e10/Hubble_h, SNIIUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIIUnProcessedElements);
			printf("Gal[%i].MetalsDiskMass[1] = %e | SNIaUnProcessedMetals = %e | TotMetalSNIaUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMass[1]*1.e10/Hubble_h, SNIaUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIaUnProcessedElements);
			printf("Gal[%i].MetalsDiskMass[2] = %e | AGBUnProcessedMetals = %e | TotMetalAGBUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMass[2]*1.e10/Hubble_h, AGBUnProcessedMetals*1.e10/Hubble_h, TotMetalAGBUnProcessedElements);
			for(ee=0;ee<NUM_ELEMENTS;ee++) {
				printf("Gal[%i].DiskMass_elements[%i] = %e | TotUnProcessedElements[%i] = %e [Msun]\n", p , ee, Gal[p].DiskMass_elements[ee], ee, SNIIUnProcessedElements[ee]+SNIaUnProcessedElements[ee]+AGBUnProcessedElements[ee]);
			}
			exit(1);
		}
		if (Gal[p].MetalsDiskMass[1] < SNIaUnProcessedMetals) {
			printf("SNe-Ia:\n");
			printf("Gal[%i].MetalsDiskMass[0] = %e | SNIIUnProcessedMetals = %e | TotMetalSNIIUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMass[0]*1.e10/Hubble_h, SNIIUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIIUnProcessedElements);
			printf("Gal[%i].MetalsDiskMass[1] = %e | SNIaUnProcessedMetals = %e | TotMetalSNIaUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMass[1]*1.e10/Hubble_h, SNIaUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIaUnProcessedElements);
			printf("Gal[%i].MetalsDiskMass[2] = %e | AGBUnProcessedMetals = %e | TotMetalAGBUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMass[2]*1.e10/Hubble_h, AGBUnProcessedMetals*1.e10/Hubble_h, TotMetalAGBUnProcessedElements);
		...
		if (Gal[p].MetalsDiskMass[2] < AGBUnProcessedMetals) {
			printf("AGBs:\n");
			printf("Gal[%i].MetalsDiskMass[0] = %e | SNIIUnProcessedMetals = %e | TotMetalSNIIUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMass[0]*1.e10/Hubble_h, SNIIUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIIUnProcessedElements);
			printf("Gal[%i].MetalsDiskMass[1] = %e | SNIaUnProcessedMetals = %e | TotMetalSNIaUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMass[1]*1.e10/Hubble_h, SNIaUnProcessedMetals*1.e10/Hubble_h, TotMetalSNIaUnProcessedElements);
			printf("Gal[%i].MetalsDiskMass[2] = %e | AGBUnProcessedMetals = %e | TotMetalAGBUnProcessedElements = %e [Msun]\n", p, Gal[p].MetalsDiskMass[2]*1.e10/Hubble_h, AGBUnProcessedMetals*1.e10/Hubble_h, TotMetalAGBUnProcessedElements);
		...
		//Check there is enough material to eject:
...
//Second, Correct metal unprocessed masses so that total metals ejected matches total metal elements ejected
		...
		for(ee=0;ee<NUM_ELEMENTS;ee++) {
			...
			TotSNIaUnProcessedElements += SNIaUnProcessedElements[ee];
			TotAGBUnProcessedElements += AGBUnProcessedElements[ee];
			/*printf("BulgeMetallicityElement_Phys[%i] = %e | Gal[p].sfh_BulgeMass_elementsRings[%i][%i][%i] = %e | (Gal[p].sfh_BulgeMassRings[%i][%i] = %e [Msun]\n",
					ee, BulgeMetallicityElement_Phys[ee], jj, ii, ee, Gal[p].sfh_BulgeMass_elementsRings[jj][ii][ee], jj, ii, (Gal[p].sfh_BulgeMassRings[jj][ii]*1.0e10/Hubble_h));*/
		}
		/*printf("\nBEFORE ELEMENT CORR:\n");
...
*/
		...
		printf("TotSNIaMassEjected = %e | TotSNIaElementsEjected = %e | Diff = %e (%e) | TotSNIaUnprocessedElements = %e [Msun]\n", SNIaEjectaMass*1.e10/Hubble_h, TotSNIaElementsEjected, (SNIaEjectaMass*1.e10/Hubble_h)-TotSNIaElementsEjected, (SNIaEjectaMass*1.e10/Hubble_h)/TotSNIaElementsEjected, TotSNIaUnProcessedElements);
		printf("TotAGBMassEjected = %e  | TotAGBElementsEjected = %e  | Diff = %e (%e) | TotAGBUnprocessedElements = %e [Msun]\n", AGBEjectaMass*1.e10/Hubble_h, TotAGBElementsEjected, (AGBEjectaMass*1.e10/Hubble_h)-TotAGBElementsEjected, (AGBEjectaMass*1.e10/Hubble_h)/TotAGBElementsEjected, TotAGBUnProcessedElements);
		//if ((fabs(SNIIElementCorrectionFactor - 1.0) > 0.00001) || (fabs(SNIaElementCorrectionFactor - 1.0) > 0.00001) || (fabs(AGBElementCorrectionFactor - 1.0) > 0.00001)) exit(1);
*/
		/*for(ee=0;ee<NUM_ELEMENTS;ee++) {
			if (SNIIAllElements[ee] < 0.0) {
				SNIIEjectaMass += SNIIAllElements[ee]; //Reduce total mass ejected accordingly
				//SNIIUnProcessedElements[ee] += SNIIAllElements[ee];
				SNIIAllElements[ee] = 0.0;
			}
			if (SNIaAllElements[ee] < 0.0) {
				SNIaEjectaMass += SNIaAllElements[ee]; //Reduce total mass ejected accordingly
				//SNIaUnProcessedElements[ee] += SNIaAllElements[ee];
				SNIaAllElements[ee] = 0.0;
			}
			if (AGBAllElements[ee] < 0.0) {
				AGBEjectaMass += AGBAllElements[ee]; //Reduce total mass ejected accordingly
				//AGBUnProcessedElements[ee] += AGBAllElements[ee];
				AGBAllElements[ee] = 0.0;
			}
		}
		TotElementsEjected = 0.0, TotUnProcessedElements = 0.0;
		TotSNIIElementsEjected = 0.0, TotSNIaElementsEjected = 0.0, TotAGBElementsEjected = 0.0;
		...
		printf("AFTER ELEMENT CORR 2:\n");
		printf("SNIIElementCorrectionFactor = %f  | SNIaElementCorrectionFactor = %f  | AGBElementCorrectionFactor = %f\n", SNIIElementCorrectionFactor, SNIaElementCorrectionFactor, AGBElementCorrectionFactor);
		printf("TotMassEjected = %e | TotElementsEjected = %e | Diff = %e | TotUnprocessedElements = %e[Msun]\n", TotMassEjected, TotElementsEjected, TotMassEjected-TotElementsEjected, TotUnProcessedElements);
		printf("TotSNIIMassEjected = %e | TotSNIIElementsEjected = %e | Diff = %e (%e) | TotSNIIUnprocessedElements = %e [Msun]\n", SNIIEjectaMass*1.e10/Hubble_h, TotSNIIElementsEjected, (SNIIEjectaMass*1.e10/Hubble_h)-TotSNIIElementsEjected, (SNIIEjectaMass*1.e10/Hubble_h)/TotSNIIElementsEjected, TotSNIIUnProcessedElements);
		printf("TotSNIaMassEjected = %e | TotSNIaElementsEjected = %e | Diff = %e (%e) | TotSNIaUnprocessedElements = %e [Msun]\n", SNIaEjectaMass*1.e10/Hubble_h, TotSNIaElementsEjected, (SNIaEjectaMass*1.e10/Hubble_h)-TotSNIaElementsEjected, (SNIaEjectaMass*1.e10/Hubble_h)/TotSNIaElementsEjected, TotSNIaUnProcessedElements);
		printf("TotAGBMassEjected = %e  | TotAGBElementsEjected = %e  | Diff = %e (%e) | TotAGBUnprocessedElements = %e [Msun]\n\n", AGBEjectaMass*1.e10/Hubble_h, TotAGBElementsEjected, (AGBEjectaMass*1.e10/Hubble_h)-TotAGBElementsEjected, (AGBEjectaMass*1.e10/Hubble_h)/TotAGBElementsEjected, TotAGBUnProcessedElements);
		printf("AGBAllElements[0] = %e\n", AGBAllElements[0]);
		if (stopper == 1) exit(1);*/
