...
void save_galaxy_tree_finalize(int filenr, int tree)
{
  ...
  //printf("Start of save_galaxy_tree_finalize\n");
  ...
  GalCount = 0;
  //printf("Created GalTree arrays: %d\n", NGalTree);
  ...
  //printf("Filled GalTree arrays: %d\n", NGalTree);
  ...
  for(i = 0; i < NGalTree; i++)
    { 
	  //printf("Begin loop for myfseek and myfread\n");
...
#ifdef REORDER_ON_DISK
  //printf("Prepared GalTree info for output\n");
  save_galaxy_tree_reorder_on_disk();
  //printf("Saved GalTree re-order on disk\n");
#endif //REORDER_ON_DISK
...
void save_galaxy_tree_reorder_on_disk(void)
{
  ...
  //printf("Begin save_galaxy_tree_reorder_on_disk\n");
  ...
  //printf("qsort done in save_galaxy_tree_reorder_on_disk\n");
