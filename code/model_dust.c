  ...
  if(Gal[p].ColdGas > 0.0)
    {
     ...
     // nh = nh * pow(1 + ZZ[Halo[halonr].SnapNum], -0.4);
      ...
      Zg/=Gal[p].ColdGas/0.02; //ROB: Is this hard-coded Zsun=0.02 a good idea? Is it a necessary assumption for this dust extinction model? We no longer thing Zsun is that large... (08-11-21).
      ...
      for(k = 0; k < NMAG; k++)
        {
    	  ...
    	  Gal[p].LumDust[k][snap] = Gal[p].LumBulge[k][snap] + Lum_disk; //ROB: Delete?
