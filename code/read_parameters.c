...
#ifdef DETAILED_DUST
  strcpy(tag[nt], "Dust_tExch");
  addr[nt] = &Dust_tExch;
  id[nt++] = DOUBLE;

  strcpy(tag[nt], "Dust_tAcc0");
  addr[nt] = &Dust_tAcc0;
  id[nt++] = DOUBLE;

  strcpy(tag[nt], "Cmax_CO");
  addr[nt] = &Cmax_CO;
  id[nt++] = DOUBLE;

  strcpy(tag[nt], "FracDustSNIItoHot");
  addr[nt] = &FracDustSNIItoHot;
  id[nt++] = DOUBLE;

  strcpy(tag[nt], "FracDustSNIatoHot");
  addr[nt] = &FracDustSNIatoHot;
  id[nt++] = DOUBLE;

  strcpy(tag[nt], "FracDustAGBtoHot");
  addr[nt] = &FracDustAGBtoHot;
  id[nt++] = DOUBLE;
#endif //DETAILED_DUST
