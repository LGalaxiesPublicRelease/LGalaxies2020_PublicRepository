 ...
 int k; //Iterator for the L-Galaxies elements arrays [0 to 10]
  ...
  for(snap=0;snap<LastDarkMatterSnapShot;snap++) //LOOP OVER SNAPSHOTS
	...
	for(kk=0;kk<LIFETIME_Z_NUM;kk++) { //LOOP OVER METALLICITIES
	  FILE *SNIIyf;
	  char filename[100];
	  sprintf(filename, "./YieldTables/SNII_burst_yields_Z%.4f.txt", lifetimeMetallicities[kk]); //_15MyrMinibin
	...
	for(kk=0;kk<LIFETIME_Z_NUM;kk++) { //LOOP OVER METALLICITIES
	  FILE *SNIayf;
	  char filename[100];
	  sprintf(filename, "./YieldTables/SNIa_burst_yields_Z%.4f.txt", lifetimeMetallicities[kk]); //_15MyrMinibin
	...
	for(kk=0;kk<LIFETIME_Z_NUM;kk++) { //LOOP OVER METALLICITIES
	  FILE *AGByf;
	  char filename[100];
	  sprintf(filename, "./YieldTables/AGB_burst_yields_Z%.4f.txt", lifetimeMetallicities[kk]); //_15MyrMinibin
