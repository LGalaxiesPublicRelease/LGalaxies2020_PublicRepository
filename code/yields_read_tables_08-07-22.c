...
void read_yield_tables(void)
{
	...
	sprintf(buf1, "./YieldTables/binary_c_yields/%s%s", bc_yields_filename, name1);
	...
	sprintf(buf2, "./YieldTables/binary_c_yields/%s%s", bc_yields_filename, name2);
	...
	for(j3=0; j3<BC_Z_NUM; j3++) {
		sprintf(buf3, "./YieldTables/binary_c_yields/%s%s", bc_yields_filename, name3[j3]);
	...
	for(j4=0; j4<BC_Z_NUM; j4++) {
		sprintf(buf4, "./YieldTables/binary_c_yields/%s%s", bc_yields_filename, name4[j4]);
	...
	for(j5=0; j5<BC_Z_NUM; j5++) {
		sprintf(buf5, "./YieldTables/binary_c_yields/%s%s", bc_yields_filename, name5[j5]);
	...
	for(j6=0; j6<BC_Z_NUM; j6++) {
		sprintf(buf6, "./YieldTables/binary_c_yields/%s%s", bc_yields_filename, name6[j6]);
	...
	for(j7=0; j7<BC_Z_NUM; j7++) {
		sprintf(buf7, "./YieldTables/binary_c_yields/%s%s", bc_yields_filename, name7[j7]);
	...
	for(j8=0; j8<BC_Z_NUM; j8++) {
		sprintf(buf8, "./YieldTables/binary_c_yields/%s%s", bc_yields_filename, name8[j8]);
	...
	for(j9=0; j9<BC_Z_NUM; j9++) {
		sprintf(buf9, "./YieldTables/binary_c_yields/%s%s", bc_yields_filename, name9[j9]);
	...
	for(j10=0; j10<BC_Z_NUM; j10++) {
		sprintf(buf10, "./YieldTables/binary_c_yields/%s%s", bc_yields_filename, name10[j10]);
	...
	for(j11=0; j11<BC_Z_NUM; j11++) {
		sprintf(buf11, "./YieldTables/binary_c_yields/%s%s", bc_yields_filename, name11[j11]);
...
//	exit(0);
	...
	for(j12=0; j12<BC_Z_NUM; j12++) {
		sprintf(buf12, "./YieldTables/binary_c_yields/%s%s", bc_yields_filename, name12[j12]);
	...
	for(j13=0; j13<BC_Z_NUM; j13++) {
		sprintf(buf13, "./YieldTables/binary_c_yields/%s%s", bc_yields_filename, name13[j13]);
	...
	for(j14=0; j14<BC_Z_NUM; j14++) {
		sprintf(buf14, "./YieldTables/binary_c_yields/%s%s", bc_yields_filename, name14[j14]);
