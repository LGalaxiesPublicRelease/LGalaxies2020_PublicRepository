...
ifeq (NORMALIZEDDB,$(findstring NORMALIZEDDB,$(OPT)))
	...
	awk -f ./AuxCode/awk/extract_GALAXY_OUTPUT.awk ./code/h_galaxy_output.i |awk -f ./AuxCode/awk/GALAXY_OUTPUT_2_python_struct.awk >  ./AuxCode/Python/LGalaxy_from_awk.py
